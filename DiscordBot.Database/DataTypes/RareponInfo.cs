...
{
    public record RareponInfo : IInfo
    {
        ...
        [Name("Crit Immunity")]
        public bool CritImmunity { get; set; }
        [Name("KB Immunity")]
        public bool KBImmunity { get; set; }
        [Name("Cnc Immunity")]
        public bool CncImmunity { get; set; }
        [Name("Burn Immunity")]
        public bool BurnImmunity { get; set; }
        [Name("Sleep Immunity")]
        public bool SleepImmunity { get; set; }
        [Name("Freeze Immunity")]
        public bool FreezeImmunity { get; set; }

        public string GetKey() => Rarepon.ToString() + Level;
    }
}
